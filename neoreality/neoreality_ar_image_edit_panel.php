<div class="neoreality_ar_image_edit_panel">
    ...
    <div id="neoreality_admin_edit_general_panel">
        <div class="neoreality_admin_manual_panels">
            ...
            <input type="text" id="neoreality_arimage_lat" name="neoreality_arimage_lat" value="<?php if(!empty($neoreality_arimage_lat)) echo $neoreality_arimage_lat; ?>"/>
            <label>Longitude</label>
            <input type="text" id="neoreality_arimage_lon" name="neoreality_arimage_lon" value="<?php
            if(!empty($neoreality_arimage_lon)) echo $neoreality_arimage_lon;
            ?>"/>
            <label>Height (in meters)</label>
            <input type="text" id="neoreality_arimage_height" name="neoreality_arimage_height" value="<?php
            if(!empty($neoreality_arimage_height)) echo $neoreality_arimage_height;
            ?>"/>
            ...
            if(!empty($neoreality_arimage_img_url)) echo $neoreality_arimage_img_url;
            ?>"/>
