...
function neorealitymap_func( $atts ) {
  ...
  $q = "(SELECT posts.ID as id, posts.post_type as type, p1.meta_value as lat, p2.meta_value as lon, p3.meta_value as height, p4.meta_value as imageurl, posts.post_title as title, p4.meta_value as content, p5.meta_value as description FROM " . $wpdb->posts . " posts, " . $wpdb->postmeta . " p1, " . $wpdb->postmeta . " p2, " . $wpdb->postmeta . " p3, " . $wpdb->postmeta . " p4, " . $wpdb->postmeta . " p5 WHERE posts.post_type='arimage' AND posts.ID=p1.post_id AND p1.post_id=p2.post_id AND p1.post_id=p3.post_id AND p1.post_id=p4.post_id AND p1.post_id=p5.post_id AND p5.meta_key='neoreality_description' AND p1.meta_key='neoreality_arimage_lat' AND p2.meta_key='neoreality_arimage_lon' AND p3.meta_key='neoreality_arimage_height' AND p4.meta_key='neoreality_arimage_img_url' AND p4.meta_value<>''   ORDER BY posts.post_date DESC LIMIT 0,100)   UNION     (SELECT posts.ID as id, posts.post_type as type, p1.meta_value as lat, p2.meta_value as lon, p3.meta_value as height, p4.meta_value as imageurl, posts.post_title as title, p4.meta_value as content, p5.meta_value as description  FROM " . $wpdb->posts . " posts, " . $wpdb->postmeta . " p1, " . $wpdb->postmeta . " p2, " . $wpdb->postmeta . " p3, " . $wpdb->postmeta . " p4, " . $wpdb->postmeta . " p5 WHERE posts.post_type='arsound' AND posts.ID=p1.post_id AND p1.post_id=p2.post_id AND p1.post_id=p3.post_id AND p1.post_id=p4.post_id AND p1.post_id=p5.post_id  AND p5.meta_key='neoreality_description' AND p1.meta_key='neoreality_arsound_lat' AND p2.meta_key='neoreality_arsound_lon' AND p3.meta_key='neoreality_arsound_height' AND p4.meta_key='neoreality_arsound_sound_url' AND p4.meta_value<>''  ORDER BY posts.post_date DESC LIMIT 0,100) UNION         (SELECT posts.ID as id, posts.post_type as type, p1.meta_value as lat, p2.meta_value as lon, p3.meta_value as height, p4.meta_value as imageurl, posts.post_title as title, p4.meta_value as content, p5.meta_value as description  FROM " . $wpdb->posts . " posts, " . $wpdb->postmeta . " p1, " . $wpdb->postmeta . " p2, " . $wpdb->postmeta . " p3, " . $wpdb->postmeta . " p4, " . $wpdb->postmeta . " p5 WHERE posts.post_type='arvideo' AND posts.ID=p1.post_id AND p1.post_id=p2.post_id AND p1.post_id=p3.post_id AND p1.post_id=p4.post_id AND p1.post_id=p5.post_id AND p5.meta_key='neoreality_description' AND p1.meta_key='neoreality_arvideo_lat' AND p2.meta_key='neoreality_arvideo_lon' AND p3.meta_key='neoreality_arvideo_height' AND p4.meta_key='neoreality_embed' AND p4.meta_value<>'' ORDER BY posts.post_date DESC LIMIT 0,100)";
  ...
  if($ru){
    ...
    for($i=0; $i<count($ru); $i++){
      ...
      "google.maps.event.addListener(mm" . $i . ", 'click', function() {iw" . $i . ".open(map,mm" . $i . ");});";
